    ...
    extend: {
      ...
      keyframes: {
        ...
        "parallax-zoom-slow": {
          ...
          "50%": { transform: "scale(1.25) translate(-5%, 5%)", opacity: "1" },
        },
        "parallax-zoom-mid": {
          "0%, 100%": { transform: "scale(1) translate(0, 0)", opacity: "0.85" },
          "50%": { transform: "scale(1.2) translate(6%, -3%)", opacity: "1" },
        },
        "parallax-zoom-fast": {
          "0%, 100%": { transform: "scale(1) translate(0, 0)", opacity: "0.9" },
          "50%": { transform: "scale(1.3) translate(-4%, 6%)", opacity: "1" },
        },
        "drift-dramatic": {
      ...
      animation: {
        ...
        "parallax-zoom-slow": "parallax-zoom-slow 35s ease-in-out infinite",
        "parallax-zoom-mid": "parallax-zoom-mid 25s ease-in-out infinite",
        "parallax-zoom-fast": "parallax-zoom-fast 18s ease-in-out infinite",
        "drift-dramatic": "drift-dramatic 12s ease-in-out infinite",
      },
    },
  },
